...
class GenBuildFile(object):
    ...
    def _gen_autogen_msg(self):
        return ('// THIS FILE IS AUTOGENERATED BY '
    ...
    def _get_versioned_name(self, prebuilt, is_etc):
        ...
        if is_etc:
            if ext != '.txt':
                print(
                    'Error: ".txt" is the expected file extension for ETC prebuilts.'
                )
                sys.exit(1)
...
def main():
    ...
    Note: VNDK snapshot must be already installed under prebuilts/vndk/v{version}.
    """
