...
WCppClass_shared* WCppClass_shared_get(WCppClass_shared* self) {
	return reinterpret_cast<WCppClass_shared*>(reinterpret_cast<std::shared_ptr<dummynamespace::CppClass>*>(self)->get());
}
...
WCppClass_shared* CppClass_returnSharedPtr(){
    return reinterpret_cast<WCppClass_shared*>(new std::shared_ptr<dummynamespace::CppClass>(dummynamespace::CppClass::returnSharedPtr())); 
}
