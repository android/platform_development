...
class CTypeMetadata final {
 public:
  ...
  const std::string createCType() const;

  const std::string createCTypeWithName(const std::string name) const;
  ...
  const std::vector<const CTypeMetadata> getTemplateArgs() const;
 ...
 private:
  ...
  const std::vector<const CTypeMetadata> template_args_;
  ...
  CTypeMetadata(const std::string c_type, const std::string cast_type,
                ...
                const bool is_reference, const bool is_const,
                const bool is_void_type, const bool is_function_pointer,
                const bool is_template, const bool is_builtin_type_,
