...
class ICustomTypeBase {
 public:
  virtual bool match(const CTypeMetadata& c_type_metadata) const = 0;
  ...
  virtual void addAsReturnType(const CTypeMetadata& c_return_type_metadata,
                               CFunctionConverter* out) const = 0;
};
