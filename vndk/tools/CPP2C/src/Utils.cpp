...
#include "customTypes/HwuiSpType.h"
#include "customTypes/SkiaSkspType.h"
#include "customTypes/StdSharedPtrType.h"
#include "customTypes/StdUniquePtrType.h"
...
void addCustomClasses(CustomTypeManager& manager) {
  manager.addType(std::make_shared<customType::StdUniquePtrType>());
  manager.addType(std::make_shared<customType::StdSharedPtrType>());
  manager.addType(std::make_shared<customType::HwuiSpType>());
  manager.addType(std::make_shared<customType::SkiaSkspType>());
}
