...
MyFrontendAction::MyFrontendAction(const HeaderConverterOptions& options)
    : options_(options) {
  init();
...
const std::string MyFrontendAction::retrieveFileName() const {
