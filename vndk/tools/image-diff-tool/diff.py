...
def main_with_zip(extarcted_paths, args):
  for origin_path, tmp_path in zip(args.target, extarcted_paths):
  ...
  main(extarcted_paths, args.search_path, args.whitelist, args.ignore_signing_key)

if __name__ == "__main__":
  parser = argparse.ArgumentParser(prog="compare_images", usage="compare_images -t model1 model2 [model...] -s dir1 [dir...] [-i] [-u] [-r] [-w whitelist1] [-w whitelist2]")
