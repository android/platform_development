...
if __name__ == "__main__":
  parser = argparse.ArgumentParser(prog="system_product_image_diff", description="Example: system_product_image_diff -t model1 model2 model3 -s system product")
  ...
  if len(args.search_path) < 1:
    parser.error("The number of search_path has to be at least one.")
