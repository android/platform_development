...
class TaggedDictTest(unittest.TestCase):
    ...
    def test_is_tag_visible(self):
        ...
        # SP-NDK
        visible_tags = {'ll_ndk', 'sp_ndk', 'sp_ndk_indirect'}
...
class TaggedLibDictTest(unittest.TestCase):
    ...
    def test_get_path_tag(self):
        ...
        self.assertEqual(
                'fwk_only',
                d.get_path_tag(MockELFLinkData('/system/lib/unknown.so')))
        self.assertEqual(
                'fwk_only',
                d.get_path_tag(MockELFLinkData('/data/lib/unknown.so')))
        self.assertEqual(
                'vnd_only',
                d.get_path_tag(MockELFLinkData('/vendor/lib/unknown.so')))
