...
class NDKLibDictTest(unittest.TestCase):
    ...
    def test_is_spndk(self):
        ...
        self.assertFalse(NDK_LIBS.is_spndk('/vendor/lib/libEGL.so'))
        self.assertFalse(NDK_LIBS.is_spndk('/vendor/lib/libGLESv1_CM.so'))
        self.assertFalse(NDK_LIBS.is_spndk('/vendor/lib/libGLESv2.so'))
        self.assertFalse(NDK_LIBS.is_spndk('/vendor/lib/libGLESv3.so'))
        self.assertFalse(NDK_LIBS.is_spndk('/vendor/lib/vulkan.so'))
