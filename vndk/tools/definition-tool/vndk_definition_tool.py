...
class TaggedDict(object):
    ...
    _TAG_VISIBILITY = {
        'll_ndk': {'ll_ndk', 'll_ndk_indirect'},
        'll_ndk_indirect': {'ll_ndk', 'll_ndk_indirect'},
        'sp_ndk': {'ll_ndk', 'sp_ndk', 'sp_ndk_indirect'},
        'sp_ndk_indirect': {'ll_ndk', 'sp_ndk', 'sp_ndk_indirect'},

        'vndk_sp': {'ll_ndk', 'sp_ndk', 'vndk_sp', 'vndk_sp_indirect',
                    'vndk_sp_indirect_private', 'fwk_only_rs'},
        'vndk_sp_indirect': {'ll_ndk', 'sp_ndk', 'vndk_sp', 'vndk_sp_indirect',
                             'vndk_sp_indirect_private', 'fwk_only_rs'},
        'vndk_sp_indirect_private': {'ll_ndk', 'sp_ndk', 'vndk_sp',
                                     'vndk_sp_indirect',
                                     'vndk_sp_indirect_private', 'fwk_only_rs'},

        'vndk': {'ll_ndk', 'sp_ndk', 'vndk_sp', 'vndk_sp_indirect', 'vndk'},

        'fwk_only': {'ll_ndk', 'll_ndk_indirect', 'sp_ndk', 'sp_ndk_indirect',
                     'vndk_sp', 'vndk_sp_indirect', 'vndk_sp_indirect_private',
                     'vndk', 'fwk_only', 'fwk_only_rs', 'sp_hal'},
        'fwk_only_rs': {'ll_ndk', 'll_ndk_indirect', 'sp_ndk',
                        'sp_ndk_indirect', 'vndk_sp', 'vndk_sp_indirect',
                        'vndk_sp_indirect_private', 'vndk', 'fwk_only',
                        'fwk_only_rs', 'sp_hal'},

        'sp_hal': {'ll_ndk', 'sp_ndk', 'vndk_sp', 'sp_hal', 'sp_hal_dep'},
        'sp_hal_dep': {'ll_ndk', 'sp_ndk', 'vndk_sp', 'sp_hal', 'sp_hal_dep'},
