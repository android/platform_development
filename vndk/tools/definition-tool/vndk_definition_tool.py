...
class VNDKLibDir(list):
    ...
    def add_version(self, version):
        """Create search paths for a given VNDK version."""
        self.append(version)
    ...
    def get_vendor_vndk_version(self, vendor_dirs):
...
class ELFLinker(object):
    ...
    def _create_internal(scan_elf_files, system_dirs, system_dirs_as_vendor,
        ...
        ro_vndk_version = vndk_lib_dirs.get_vendor_vndk_version(vendor_dirs)
