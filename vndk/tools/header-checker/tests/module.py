...
TEST_MODULES = [
    ...
    LsdumpModule(
        name='libmerge_multi_definition',
        arch='arm64',
        srcs=[
            'integration/merge_multi_definition/include/def1.h',
            'integration/merge_multi_definition/include/def2.h',
        ],
        version_script='integration/merge_multi_definition/map.txt',
        export_include_dirs=['integration/merge_multi_definition/include'],
