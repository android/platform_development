...
abi_util::VTableComponentIR RecordDeclWrapper::SetupRecordVTableComponent(
  ...
  auto vtable_component_ir =
      abi_util::VTableComponentIR(mangled_component_name, kind, value);
  vtable_component_ir.SetIsInlined(is_inlined);
  vtable_component_ir.SetIsPure(is_pure);
  return vtable_component_ir;
}
