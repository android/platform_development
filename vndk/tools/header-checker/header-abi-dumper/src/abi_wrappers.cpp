...
// type and information to tell the clients of this method whether the type
// returned is in a valid state or not. They can therefore decide whether to
// continue filling in more information about the type created.
