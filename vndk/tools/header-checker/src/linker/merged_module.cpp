...
#include "linker/merged_module.h"
...
MergeStatus MergedModuleIR::MergeBuiltinType(
...
MergeStatus MergedModuleIR::LookupUserDefinedType(
...
MergeStatus MergedModuleIR::LookupType(
...
MergeStatus MergedModuleIR::MergeReferencingTypeInternal(
...
void MergedModuleIR::MergeRecordFields(
...
void MergedModuleIR::MergeRecordCXXBases(
    const ModuleIR &addend, RecordTypeIR *added_node,
    AbiElementMap<MergeStatus> *local_to_global_type_id_map) {
...
void MergedModuleIR::MergeRecordTemplateElements(
    const ModuleIR &addend, RecordTypeIR *added_node,
    AbiElementMap<MergeStatus> *local_to_global_type_id_map) {
...
void MergedModuleIR::MergeRecordDependencies(
    const ModuleIR &addend, RecordTypeIR *added_node,
    AbiElementMap<MergeStatus> *local_to_global_type_id_map) {
...
MergedModuleIR::UpdateUDTypeAccounting(
...
MergeStatus MergedModuleIR::MergeRecordAndDependencies(
...
void MergedModuleIR::MergeEnumDependencies(
...
MergeStatus MergedModuleIR::MergeEnumType(
...
MergeStatus MergedModuleIR::MergeFunctionType(
...
template <typename T>
MergeStatus MergedModuleIR::MergeReferencingTypeInternalAndUpdateParent(
...
MergeStatus MergedModuleIR::MergeReferencingType(
...
MergeStatus MergedModuleIR::MergeTypeInternal(
    const TypeIR *addend_node, const ModuleIR &addend,
    AbiElementMap<MergeStatus> *local_to_global_type_id_map) {
  switch (addend_node->GetKind()) {
...
MergeStatus MergedModuleIR::MergeType(
    const TypeIR *addend_node, const ModuleIR &addend,
    AbiElementMap<MergeStatus> *local_to_global_type_id_map) {
...
void MergedModuleIR::MergeCFunctionLikeDeps(
...
void MergedModuleIR::MergeFunctionDeps(
...
void MergedModuleIR::MergeFunction(
...
std::string MergedModuleIR::AllocateNewTypeId(const std::string &addend_type_id,
                                              const ModuleIR &addend_module) {
  return addend_type_id + "#ODR:" + addend_module.GetCompilationUnitPath();
}


void MergedModuleIR::MergeGlobalVariable(
...
void MergedModuleIR::MergeGraphs(const ModuleIR &addend) {
