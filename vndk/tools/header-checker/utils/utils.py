...
def make_libraries(product, variant, targets, libs, llndk_mode):
    ...
    lsdump_paths = build_and_read_lsdump_paths(product, variant, targets)
    targets = []
    for name in libs:
...
def read_lsdump_paths(lsdump_paths_file_path, targets):
