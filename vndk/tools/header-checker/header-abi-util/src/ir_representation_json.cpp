...
void JsonObject::Set(const char *key, bool value) {
  SetOmissible(key, value, false);
}

void JsonObject::Set(const char *key, uint64_t value) {
  SetOmissible<Json::UInt64>(key, value, 0);
}

void JsonObject::Set(const char *key, int64_t value) {
  SetOmissible<Json::Int64>(key, value, 0);
}

void JsonObject::Set(const char *key, const std::string &value) {
  SetOmissible<const std::string &>(key, value, "");
}

void JsonObject::Set(const char *key, const JsonArray &value) {
