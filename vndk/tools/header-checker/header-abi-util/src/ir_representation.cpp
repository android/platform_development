...
TextFormatToIRReader::CreateTextFormatToIRReader(
    TextFormatIR text_format, const std::vector<std::string> &dump_files) {
  return CreateTextFormatToIRReader(text_format, dump_files.begin(),
                                    dump_files.end());
}

std::unique_ptr<TextFormatToIRReader>
TextFormatToIRReader::CreateTextFormatToIRReader(
    TextFormatIR text_format, std::vector<std::string>::const_iterator begin,
