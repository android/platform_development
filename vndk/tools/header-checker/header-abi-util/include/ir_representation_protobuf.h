...
class ProtobufTextFormatToIRReader : public TextFormatToIRReader {
 public:
  ...
  private:
   ...
   std::vector<ElfObjectIR> ReadElfObjects (
       const abi_dump::TranslationUnit &tu);
...
class ProtobufIRDiffDumper : public IRDiffDumper {
 public:
  ...
  virtual CompatibilityStatusIR GetCompatibilityStatusIR() override;
 ...
 private:
  ...
  bool AddElfObjectIR(const ElfObjectIR *elf_object_ir,
                      DiffKind diff_kind);
