...
class IRToProtobufConverter {
 ...
 public:
  ...
  static abi_dump::RecordType ConvertRecordTypeIR(
    const RecordTypeIR *recordp);

  static bool AddFunctionParameters(
    abi_dump::FunctionDecl *function_protobuf,
    const FunctionIR *function_ir);
  static abi_dump::FunctionDecl ConvertFunctionIR(
...
class ProtobufTextFormatToIRReader : public TextFormatToIRReader {
 public:
  ...
  private:
   ...
   std::vector<std::string> ReadElfFunctions (
       const abi_dump::TranslationUnit &tu);

   std::vector<std::string> ReadElfObjects (
       const abi_dump::TranslationUnit &tu);
...
class ProtobufIRDiffDumper : public IRDiffDumper {
 public:
  ...
  virtual CompatibilityStatusIR GetCompatibilityStatusIR(
      bool check_all_apis) override;
