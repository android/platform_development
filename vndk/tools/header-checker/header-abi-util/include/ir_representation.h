...
class RecordTypeIR: public TypeIR, public TemplatedArtifactIR {
 public:
  ...
  void SetStruct(RecordKind record_kind) {
  ...
  bool IsStruct() const {
    return  record_kind_ == RecordKind::struct_kind;
  }
  bool IsClass() const {
    return  record_kind_ == RecordKind::class_kind;
  }
  bool IsUnion() const {
    return  record_kind_ == RecordKind::union_kind;
  }
 protected:
...
class TextFormatToIRReader {
 public:
  ...
  const std::vector<std::string> &GetElfFunctions() const {
    return elf_functions_;
  }
  const std::vector<std::string> &GetElfObjects() const {
    return elf_objects_;
  }
 ...
 protected:
  ...
  std::vector<std::string> elf_functions_;
  std::vector<std::string> elf_objects_;
};
...
class RecordTypeDiffIR : public DiffMessageIR {
 ...
 protected:
  // optional implemented with vector.
