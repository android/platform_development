...
class HeaderAbiDiff {
 public:
  HeaderAbiDiff(const std::string &lib_name, const std::string &arch,
                ...
                bool check_all_apis, const std::string &text_format_old,
                const std::string &text_format_new,
                const std::string &text_format_diff)
 ...
 private:
  ...
  const std::string &text_format_old_;
  const std::string &text_format_new_;
  const std::string &text_format_diff_;
};
