...
static llvm::cl::opt<std::string> text_format_old(
    "text-format-old", llvm::cl::desc("<text-format : eg: protobuf, xml>"),
    llvm::cl::Optional, llvm::cl::init("protobuf"),
    llvm::cl::cat(header_checker_category));

static llvm::cl::opt<std::string> text_format_new(
    "text-format-new", llvm::cl::desc("<text-format : eg: protobuf, xml>"),
    llvm::cl::Optional, llvm::cl::init("protobuf"),
    llvm::cl::cat(header_checker_category));

static llvm::cl::opt<std::string> text_format_diff(
    "text-format-diff", llvm::cl::desc("<text-format : eg: protobuf, xml>"),
    llvm::cl::Optional, llvm::cl::init("protobuf"),
    llvm::cl::cat(header_checker_category));
