...
DiffWrapper<RecordDecl, RecordDeclDiff>::GetInternal() {
...
DiffWrapper<EnumDecl, EnumDeclDiff>::GetInternal() {
...
DiffWrapper<FunctionDecl, FunctionDeclDiff>::GetInternal() {
...
DiffWrapper<GlobalVarDecl, GlobalVarDeclDiff>::GetInternal() {
