...
window.onload=function() { 
  ...
  $.getJSON('/get_started', {
      ...
      for(i=0;i<len;i++) {
          if (done[i])
              $('#item_list').append('<pre><a class="list-group-item list-group-item-success" onclick="set_item(this)">' + lst[i] + '</a></pre>');
          else
              $('#item_list').append('<pre><a class="list-group-item list-group-item-danger" onclick="set_item(this)">' + lst[i] + '</a></pre>');
      }
