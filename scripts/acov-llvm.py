...
# generating aLLVM coverage report from that information. To use:
#
...
#
# 3. Flush coverage
# from daemons and system processes on the device
...
#   $ acov-llvm.py report -b <one-or-more-binaries-in-$OUT> \
...
def do_clean_device(args):
    ...
    adb_shell(['rm', '-rf', '/data/misc/trace/*'])
