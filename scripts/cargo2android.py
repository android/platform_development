...
class Crate(object):
  ...
  def feature_list(self):
    ...
    if pkg.startswith('.../'):  # keep only the main package name
      ...
      # Absolute path for a local package;
      # remove common prefix up to my parent directory.
      parent_dir = os.path.dirname(os.getcwd()) + '/'
      common_prefix = os.path.commonprefix([pkg, parent_dir])
      pkg = '.../' + pkg[len(common_prefix):]
...
class Runner(object):
  ...
  def run_cargo(self):
    ...
    if self.args.add_workspace:
      ...
      found_workspace = '[workspace]' in cargo_toml_lines
      if found_workspace:
