...
class Crate(object):
  ...
  def parse(self, line_num, line):
    ...
    if not self.crate_types:
      ...
      if 'test' in self.cfgs:
        ...
        self.errors += 'ERROR: missing --crate-type and --test\n'
  ...
  def decide_one_module_type(self, crate_type):
    ...
    if crate_type == 'bin':  # rust_binary[_host]
      ...
      if self.module_name:
        # In bindgen-0.53.2, two test modules have the same crate_name but
        # cannot be merged. We need to use different module_name and stem.
