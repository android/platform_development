...
def FindToolchain():
  ...
  # /huge-ssd/aosp-arm64/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin
  tc1 = os.environ["ANDROID_TOOLCHAIN"]
  # /huge-ssd/aosp-arm64/prebuilts/gcc/linux-x86/arm/arm-linux-androideabi-4.8/bin
