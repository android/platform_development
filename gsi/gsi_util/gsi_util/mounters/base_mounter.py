...
class BaseFileAccessor(object):
  ...
  def _handle_prepare_file(self, file_in_storage):
    ...
    Args:
      file_in_storage: the file in the storage to be prepared
  ...
  def prepare_file(self, file_in_storage):
    ...
    Args:
      file_in_storage: the file to map.
        file_in_storage should be a full path file as the path in a real device,
    ...
    Returns:
      ...
      storage.
    """
    pathfile_in_mount = self._get_pathfile_to_access(file_in_storage)
