...
DumpInfoListItem = namedtuple(
    'DumpInfoListItem', 'id dumper_create_args dump_index')
...
INFO_LIST = [
    ...
    DumpInfoListItem('vendor_zygote', VENDOR_DEFAULT_PROP_DUMPER, 'ro.zygote')] # pyformat: disable
