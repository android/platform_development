...
LOCAL_FILES += \
  $(HOST_OUT_INTERMEDIATES)/NOTICE.txt:NOTICE.txt \
  $(HOST_OUT)/development/sdk/plat_tools_source.properties:source.properties \
  $(HOST_OUT_EXECUTABLES)/mke2fs.conf
...
LOCAL_FILES += \
  $($(my_prefix)OUT_SHARED_LIBRARIES)/AdbWinUsbApi.dll \
  $($(my_prefix)OUT_SHARED_LIBRARIES)/AdbWinApi.dll \
