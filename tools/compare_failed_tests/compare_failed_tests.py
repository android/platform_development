...
def main():
  ...
  parser.add_argument('test_result_a')
  parser.add_argument('test_result_b')
  parser.add_argument('--csv', default='diff.csv')
  ...
  with open(args.csv, 'w') as csvfile:
    compare_failed_tests(test_result_a, test_result_b, csvfile,
