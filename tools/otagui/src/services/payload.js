...
export class Payload {
  ...
  readManifest() {
    ...
    let update_metadata_pb = protobuf.Root.fromJSON(require("@/services/update_metadata_pb.json"))
    let message = update_metadata_pb.lookup('DeltaArchiveManifest')
    this.manifest = message.decode(manifest_raw)
  }
  ...
  readSignature() {
    ...
    let update_metadata_pb = protobuf.Root.fromJSON(require("@/services/update_metadata_pb.json"))
    let message = update_metadata_pb.lookup('Signatures')
    this.metadata_signature = message.decode(signature_raw)
  }
...
export class OpType {
  ...
  constructor() {
    let update_metadata_pb = protobuf.Root.fromJSON(require("@/services/update_metadata_pb.json"))
    let message = update_metadata_pb.lookup('InstallOperation')
    let types = message.Type
