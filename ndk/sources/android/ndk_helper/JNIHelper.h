...
public:
    /*
     * To load your own Java classes, class loader requires an instance of
     * ANativeActivity.
     * This methods need to be called before any call to the helper class.
     * Static member of the class
     *
     * arguments:
     * in: activity, pointer to ANativeActivity. Used internaly to set up JNI environment
     ...
     *  in: encode, pointer to a character encode string. e.g. "UTF-16", "Shift_JIS"
     * return: std::string converted string in UTF-8
     */
