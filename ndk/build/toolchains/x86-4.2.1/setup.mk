...
$(eval __x86_sources := $(call get-src-files-with-tag,x86)) \
$(eval __debug_sources := $(call get-src-files-with-tag,debug)) \
$(eval __release_sources := $(call get-src-files-without-tag,debug)) \
$(call set-src-files-target-cflags, \
    $(call set_intersection,$(__x86_sources),$(__debug_sources)), \
    $(TARGET_x86_debug_CFLAGS)) \
$(call set-src-files-target-cflags,\
    $(call set_intersection,$(__x86_sources),$(__release_sources)),\
    $(TARGET_x86_release_CFLAGS)) \
$(call set-src-files-target-cflags,\
    $(call set_intersection,$(__x86_sources),$(__debug_sources)),\
    $(TARGET_x86_debug_CFLAGS)) \
$(call set-src-files-text,$(__x86_sources),x86$(space)$(space)) \
