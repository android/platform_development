...
UBreakIterator * ubrk_openBinaryRules(const uint8_t * binaryRules, int32_t rulesLength, const UChar * text, int32_t textLength, UErrorCode * status) {
  typedef decltype(&ubrk_openBinaryRules) FuncPtr;
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_common, "ubrk_openBinaryRules"));

  if (ptr == nullptr) {
    do_fail("ubrk_openBinaryRules");
  }

  return ptr(binaryRules, rulesLength, text, textLength, status);
}
...
int32_t ubrk_getBinaryRules(UBreakIterator * bi, uint8_t * binaryRules, int32_t rulesCapacity, UErrorCode * status) {
  typedef decltype(&ubrk_getBinaryRules) FuncPtr;
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_common, "ubrk_getBinaryRules"));

  if (ptr == nullptr) {
    do_fail("ubrk_getBinaryRules");
  }

  return ptr(bi, binaryRules, rulesCapacity, status);
}
...
uint32_t ubiditransform_transform(UBiDiTransform * pBiDiTransform, const UChar * src, int32_t srcLength, UChar * dest, int32_t destSize, UBiDiLevel inParaLevel, UBiDiOrder inOrder, UBiDiLevel outParaLevel, UBiDiOrder outOrder, UBiDiMirroring doMirroring, uint32_t shapingOptions, UErrorCode * pErrorCode) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_common, "ubiditransform_transform"));

  if (ptr == nullptr) {
    do_fail("ubiditransform_transform");
  }
...
UBiDiTransform * ubiditransform_open(UErrorCode * pErrorCode) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_common, "ubiditransform_open"));

  if (ptr == nullptr) {
    do_fail("ubiditransform_open");
  }
...
void ubiditransform_close(UBiDiTransform * pBidiTransform) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_common, "ubiditransform_close"));

  if (ptr == nullptr) {
    do_fail("ubiditransform_close");
  }
...
UEnumeration * uplrules_getKeywords(const UPluralRules * uplrules, UErrorCode * status) {
  typedef decltype(&uplrules_getKeywords) FuncPtr;
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "uplrules_getKeywords"));

  if (ptr == nullptr) {
    do_fail("uplrules_getKeywords");
  }

  return ptr(uplrules, status);
}
...
UListFormatter * ulistfmt_open(const char * locale, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "ulistfmt_open"));
...
void ulistfmt_close(UListFormatter * listfmt) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "ulistfmt_close"));
...
int32_t ulistfmt_format(const UListFormatter * listfmt, const UChar *const  strings[], const int32_t * stringLengths, int32_t stringCount, UChar * result, int32_t resultCapacity, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "ulistfmt_format"));
...
URelativeDateTimeFormatter * ureldatefmt_open(const char * locale, UNumberFormat * nfToAdopt, UDateRelativeDateTimeFormatterStyle width, UDisplayContext capitalizationContext, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "ureldatefmt_open"));

  if (ptr == nullptr) {
    do_fail("ureldatefmt_open");
  }
...
void ureldatefmt_close(URelativeDateTimeFormatter * reldatefmt) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "ureldatefmt_close"));

  if (ptr == nullptr) {
    do_fail("ureldatefmt_close");
  }
...
int32_t ureldatefmt_formatNumeric(const URelativeDateTimeFormatter * reldatefmt, double offset, URelativeDateTimeUnit unit, UChar * result, int32_t resultCapacity, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "ureldatefmt_formatNumeric"));

  if (ptr == nullptr) {
    do_fail("ureldatefmt_formatNumeric");
  }
...
int32_t ureldatefmt_format(const URelativeDateTimeFormatter * reldatefmt, double offset, URelativeDateTimeUnit unit, UChar * result, int32_t resultCapacity, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "ureldatefmt_format"));

  if (ptr == nullptr) {
    do_fail("ureldatefmt_format");
  }
...
int32_t ureldatefmt_combineDateAndTime(const URelativeDateTimeFormatter * reldatefmt, const UChar * relativeDateString, int32_t relativeDateStringLen, const UChar * timeString, int32_t timeStringLen, UChar * result, int32_t resultCapacity, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "ureldatefmt_combineDateAndTime"));

  if (ptr == nullptr) {
    do_fail("ureldatefmt_combineDateAndTime");
  }
...
int32_t unum_formatDoubleForFields(const UNumberFormat * format, double number, UChar * result, int32_t resultLength, UFieldPositionIterator * fpositer, UErrorCode * status) {
  typedef decltype(&unum_formatDoubleForFields) FuncPtr;
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "unum_formatDoubleForFields"));

  if (ptr == nullptr) {
    do_fail("unum_formatDoubleForFields");
  }

  return ptr(format, number, result, resultLength, fpositer, status);
}
...
int32_t uspoof_check2(const USpoofChecker * sc, const UChar * id, int32_t length, USpoofCheckResult * checkResult, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "uspoof_check2"));

  if (ptr == nullptr) {
    do_fail("uspoof_check2");
  }
...
int32_t uspoof_check2UTF8(const USpoofChecker * sc, const char * id, int32_t length, USpoofCheckResult * checkResult, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "uspoof_check2UTF8"));

  if (ptr == nullptr) {
    do_fail("uspoof_check2UTF8");
  }
...
USpoofCheckResult * uspoof_openCheckResult(UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "uspoof_openCheckResult"));

  if (ptr == nullptr) {
    do_fail("uspoof_openCheckResult");
  }
...
void uspoof_closeCheckResult(USpoofCheckResult * checkResult) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "uspoof_closeCheckResult"));

  if (ptr == nullptr) {
    do_fail("uspoof_closeCheckResult");
  }
...
int32_t uspoof_getCheckResultChecks(const USpoofCheckResult * checkResult, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "uspoof_getCheckResultChecks"));

  if (ptr == nullptr) {
    do_fail("uspoof_getCheckResultChecks");
  }
...
URestrictionLevel uspoof_getCheckResultRestrictionLevel(const USpoofCheckResult * checkResult, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "uspoof_getCheckResultRestrictionLevel"));

  if (ptr == nullptr) {
    do_fail("uspoof_getCheckResultRestrictionLevel");
  }
...
const USet * uspoof_getCheckResultNumerics(const USpoofCheckResult * checkResult, UErrorCode * status) {
  ...
  static FuncPtr ptr = reinterpret_cast<FuncPtr>(
      do_dlsym(&handle_i18n, "uspoof_getCheckResultNumerics"));

  if (ptr == nullptr) {
    do_fail("uspoof_getCheckResultNumerics");
  }
