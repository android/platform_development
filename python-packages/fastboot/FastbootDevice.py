...
class FastbootDevice(object):
    ...
    def flashall(self, wipe_user=True, slot=None, skipSecondary=False, quiet=True):
    ...
    def flash(self, partition='cache', img=None, slot=None, skipSecondary=False, quiet=True):
