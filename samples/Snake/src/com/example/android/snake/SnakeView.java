...
public class SnakeView extends TileView {
    ...
    /**
     * Figure out which way the snake is going, see if they's run into anything (the walls, himself,
     * or an apple). If they's not going to die, we then add to the front and subtract from the rear
