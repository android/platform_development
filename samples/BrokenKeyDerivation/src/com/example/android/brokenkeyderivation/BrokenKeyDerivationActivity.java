...
public class BrokenKeyDerivationActivity extends Activity {
    ...
    // fashion, perhaps the existence of a file with a certain name can indicate that the process
    // has already been done, as to use the secure key and avoid re-encrypting. Here we use a
    // boolean as a mock.
    ...
    // Salt must be stored on disk. Here we use an array as a mock and use the a null value
    // to indicate that it's not present.
