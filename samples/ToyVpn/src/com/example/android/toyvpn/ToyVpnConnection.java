...
public class ToyVpnConnection implements Runnable {
    ...
    public interface Listener {
        void onEstablish(final int id, ParcelFileDescriptor tunInterface);
        void onDisconnect(final int id);
    }
    ...
    public ToyVpnConnection(VpnService service, Listener listener, int connectionId,
            String serverName, int serverPort, byte[] sharedSecret) {
        mService = service;
        mListener = listener;
