...
MERGE_TARGET_FILES_OPTIONS+=" --framework-item-list=${ANDROID_BUILD_TOP}/development/partial_build/framework_files.list"
MERGE_TARGET_FILES_OPTIONS+=" --framework-misc-info-keys=${ANDROID_BUILD_TOP}/development/partial_build/misc_info_keys.list"
MERGE_TARGET_FILES_OPTIONS+=" --vendor-item-list=${ANDROID_BUILD_TOP}/development/partial_build/partial_files.list"
